...
def test_openapi_keeps_release_endpoints_and_unique_operation_ids():
    ...
    required_operations = {
        ...
        ("/api/v1/pilot-execution/releases/{release_id}/operations", "get"),
        ("/api/v1/pilot-execution/releases/{release_id}/enrollments", "get"),
        ("/api/v1/pilot-execution/releases/{release_id}/stop", "post"),
        ("/api/v1/pilot-execution/releases/{release_id}/stop", "get"),
        ("/api/v1/pilot-execution/releases/{release_id}/acceptance", "get"),
        ("/api/v1/pilot-execution/releases/{release_id}/visits/{visit_id}/enroll", "post"),
        ("/api/v1/pilot-execution/visits/{visit_id}/enrollment", "get"),
        ("/api/v1/pilot-readiness/manual-gates", "get"),
        ("/api/v1/pilot-readiness/manual-gates/launch-package-preview", "get"),
        ("/api/v1/pilot-readiness/manual-gates/launch-packages", "get"),
        ("/api/v1/pilot-readiness/manual-gates/launch-packages", "post"),
        (
            "/api/v1/pilot-readiness/manual-gates/launch-packages/{package_id}",
            "get",
        ),
        (
